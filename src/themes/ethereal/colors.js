Theme.register('ethereal', {
    mode: 'dark',
    backgrounds: [
        './src/themes/ethereal/backgrounds/1-cosmic.webp',
        './src/themes/ethereal/backgrounds/2-meadow.webp',
        './src/themes/ethereal/backgrounds/omarchy.webp',
    ],
    colors: {
        accent: '#7d82d9',
        selection: '#252e56',
