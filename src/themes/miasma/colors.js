Theme.register('miasma', {
    mode: 'dark',
    backgrounds: [
        './src/themes/miasma/backgrounds/01-nature-of-fear.webp',
        './src/themes/miasma/backgrounds/02-crowned.webp',
        './src/themes/miasma/backgrounds/omarchy.webp',
    ],
    colors: {
        accent: '#78824b',
        selection: '#383838',
