Theme.register('lumon', {
    mode: 'dark',
    backgrounds: [
        './src/themes/lumon/backgrounds/01-united-in-severance.webp',
        './src/themes/lumon/backgrounds/02-opinions-equally.webp',
        './src/themes/lumon/backgrounds/omarchy.webp',
    ],
    colors: {
        accent: '#8bc9eb',
        selection: '#243d56',
